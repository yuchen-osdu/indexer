...
@IncludeTags({"as-ingested-coordinates"})
...
@ConfigurationParameter(
    ...
    value = "pretty,junit:target/cucumber-reports/TEST-indexrecord-as-ingested-coordinates.xml,io.qameta.allure.cucumber7jvm.AllureCucumber7Jvm")
public class RunAsIngestedCoordinatesTest {
}
