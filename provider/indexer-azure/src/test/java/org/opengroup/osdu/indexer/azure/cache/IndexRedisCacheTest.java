...
/**
 * Unit tests for IndexRedisCache to verify AMR-safe clearAll() behavior.
 *
...
public class IndexRedisCacheTest extends RedisCacheTestBase<Boolean, IndexRedisCache> {

    @Override
    protected IndexRedisCache createCache(RedisConfig redisConfig) {
        return new IndexRedisCache(redisConfig);
    }
