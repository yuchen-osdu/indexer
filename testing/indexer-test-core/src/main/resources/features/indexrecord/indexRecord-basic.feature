Feature: Basic Indexing of Documents
  ...
  Scenario Outline: Ingest the record and Index in the Elastic Search with bad attribute
    ...
    Examples:
      ...
      | "tenant1:indexer<timestamp>:test-data--Integration:2.0.1" | "index_records_2_basic" | 4      | "tenant1-indexer<timestamp>-test-data--integration-2.0.1" | "data.Location"       | "data.default.viewers@tenant1" |
      | "tenant1:indexer<timestamp>:test-data--Integration:2.0.1" | "index_records_2_basic" | 1      | "tenant1-indexer<timestamp>-test-data--integration-2.0.1" | "data.InvalidInteger" | "data.default.viewers@tenant1" |

  @default
  Scenario Outline: Ingest the record and Index in the Elastic Search with tags
    Given the schema is created with the following kind
      | kind                                           | index                                          | schemaFile      |
      | tenant1:indexer<timestamp>:test-data--Integration:1.1.1 | tenant1-indexer<timestamp>-test-data--integration-1.1.1 | index_records_1_basic |
    When I ingest records with the <recordFile> with <acl> for a given <kind>
    ...
    Examples:
      ...
      | "tenant1:indexer<timestamp>:test-data--Integration:1.1.1" | "index_records_1_basic" | "tenant1-indexer<timestamp>-test-data--integration-1.1.1" | "data.default.viewers@tenant1" | "testtag" | "testvalue" | 5      |

  @default
  Scenario Outline: Ingest the r3-record with geo-shape and Index in the Elastic Search
    Given the schema is created with the following kind
      | kind                                      | index                                     | schemaFile                 |
      | tenant1:wks<timestamp>:master-data--Wellbore:2.0.3 | tenant1-wks<timestamp>-master-data--wellbore-2.0.3 | r3-index_record_wks_master_basic |
    When I ingest records with the <recordFile> with <acl> for a given <kind>
    ...
    Examples:
      ...
      | "tenant1:wks<timestamp>:master-data--Wellbore:2.0.3" | "r3-index_record_wks_master_basic" | 1      | "tenant1-wks<timestamp>-master-data--wellbore-2.0.3" | "data.default.viewers@tenant1" | "data.SpatialLocation.Wgs84Coordinates" | 52                | -100               | 0                     | 100                    |
  ...
  Scenario Outline: Ingest record and check for properly parsed array of Strings
    ...
    Examples:
      ...
      | "osdu:wks<timestamp>:reference-data--IndexPropertyPathConfiguration:1.1.1" | "well_augmenter_configuration_basic" | "osdu-wks<timestamp>-reference-data--indexpropertypathconfiguration-1.1.1" | "data.AttributionAuthority.keyword" | "CustomAttributionAuthority" | "data.default.viewers@tenant1" | "data.Configurations.Paths.RelatedObjectsSpec.RelatedConditionMatches" | "opendes:reference-data--GeoPoliticalEntityType:Country:" |

  @default
  Scenario Outline: Ingest records with geo-shape and Index with virtual properties in the Elastic Search
    Given the schema is created with the following kind
      | kind                                                   | index                                                  | schemaFile                      |
      | tenant1:indexer<timestamp>:virtual-properties-Integration:1.0.0 | tenant1-indexer<timestamp>-virtual-properties-integration-1.0.0 | index_record_virtual_properties_basic |
      | tenant1:indexer<timestamp>:decimation-Integration:1.0.0         | tenant1-indexer<timestamp>-decimation-integration-1.0.0         | index_record_seismic_survey_basic     |
    When I ingest records with the <recordFile> with <acl> for a given <kind>
    Then I should be able search <number> documents for the <index> by bounding box query with points (<top_left_latitude>, <top_left_longitude>) and  (<bottom_right_latitude>, <bottom_right_longitude>) on field <field>

    Examples:
      | kind                                                   | recordFile                        | number | index                                                  | acl                            | field                                                      | top_left_latitude | top_left_longitude | bottom_right_latitude | bottom_right_longitude |
      | "tenant1:indexer<timestamp>:virtual-properties-Integration:1.0.0" | "index_record_virtual_properties_basic" | 3      | "tenant1-indexer<timestamp>-virtual-properties-integration-1.0.0" | "data.default.viewers@tenant1" | "data.VirtualProperties.DefaultLocation.Wgs84Coordinates" | 90                | -180               | -90                   | 180                    |
      | "tenant1:indexer<timestamp>:decimation-Integration:1.0.0"        | "index_record_seismic_survey_basic"     | 1      | "tenant1-indexer<timestamp>-decimation-integration-1.0.0"         | "data.default.viewers@tenant1" | "data.VirtualProperties.DefaultLocation.Wgs84Coordinates" | 90                | -180               | -90                   | 180                    |

  @default
  Scenario Outline: Ingest the r3-record with arrays of objects and hints in schema and Index in the Elastic Search
    Given the schema is created with the following kind
      | kind                                              | index                                             | schemaFile                     |
      | tenant1:wks<timestamp>:ArraysOfObjectsTestCollection:4.0.0 | tenant1-wks<timestamp>-arraysofobjectstestcollection-4.0.0 | r3-index_record_arrayofobjects_basic |
    When I ingest records with the <recordFile> with <acl> for a given <kind>
  ...
  Scenario Outline: Synchronize meta attribute mapping on existing indexed kind
    ...
    Examples:
      ...
      | "tenant1:indexer<timestamp>:test-mapping--Sync:2.0.0" | "tenant1-indexer<timestamp>-test-mapping--sync-2.0.0" | "index_record_sync_mapping_basic" | "index_record_sync_mapping_basic" | "data.default.viewers@tenant1" |

  @default
  Scenario Outline: Ingest the record and Index in the Elastic Search
    Given the schema is created with the following kind
      | kind                                               | index                                              | schemaFile                   |
      | tenant1:indexer<timestamp>:test-update-data--Integration:1.0.1 | tenant1-indexer<timestamp>-test-update-data--integration-1.0.1 | index_update_records_kind_v1_basic |
      | tenant1:indexer<timestamp>:test-update-data--Integration:2.0.1 | tenant1-indexer<timestamp>-test-update-data--integration-2.0.1 | index_update_records_kind_v2_basic |
    ...
    Examples:
      ...
      | "tenant1:indexer<timestamp>:test-update-data--Integration:1.0.1" | "tenant1-indexer<timestamp>-test-update-data--integration-1.0.1" | "index_update_records_kind_v1_basic" | "data.default.viewers@tenant1" | "tenant1:indexer<timestamp>:test-update-data--Integration:2.0.1" | "tenant1-indexer<timestamp>-test-update-data--integration-2.0.1" |
