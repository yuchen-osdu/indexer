...
public class PollingConfig {
    ...
    public static class Builder {
        ...
        private long[] waitTimes = {1000, 2000, 3000, 5000, 8000, 10000, 15000}; // Default exponential backoff
    ...
    public static PollingConfig indexCreation() {
        return builder()
            .withMaxAttempts(4)
            .withWaitTimes(2000, 5000, 10000, 15000)
    ...
    public static PollingConfig indexDeletion() {
        return builder()
            .withMaxAttempts(4)
            .withWaitTimes(3000, 6000, 9000, 12000)
    ...
    /**
     * Alias for {@link #documentPolling()} — uses the same configuration.
     * Kept as a separate method for readability at call sites where
     * an expected document count is being verified.
     */
